  ...
  const createPayload = async (data, images) => {
    return {
      ...
      metadata: {
        ...
        images: await uploadFiles(images).then((url) => url[0]),
      },
    };
  };
...
const createBlank = () => {
  return {
    ...
    metadata: {
      main_display: false,
      home_image:
        "https://theme.hstatic.net/1000226014/1001131491/14/home_category_img_2.png?v=2090",
      main_image:
        "https://file.hstatic.net/1000226014/collection/banner_goi_khach_san_blue-01_b1f5561291e445a5856eed39919c2f55.png",
    },
  };
};
